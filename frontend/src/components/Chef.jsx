    ...
    <section id="chef" className="py-32 px-6 md:px-20 bg-transparent relative overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="relative group overflow-hidden rounded-[4rem] h-[650px]">
          ...
          <ResponsiveImage ref={imageRef} src="/chef_adnan.png" alt="Master Chef Adnan" loading="lazy" sizes="(max-width: 768px) 100vw, 50vw" width="1024" height="1024" className="absolute inset-0 w-full h-full object-cover contrast-[1.05] z-10" />
        </div>
