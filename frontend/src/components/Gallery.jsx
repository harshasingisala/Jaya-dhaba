    ...
    <section className="py-32 px-6 md:px-20 bg-transparent">
      ...
      <div ref={containerRef} className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
        {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
          <div key={i} className="aspect-square relative group overflow-hidden rounded-[2.5rem] shadow-xl border border-heritage-espresso/5 bg-heritage-stone">
            <div className="w-full h-full overflow-hidden">
               <ResponsiveImage src={i % 2 === 0 ? '/paneer.png' : '/chicken.png'} className="parallax-img absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000 grayscale-[0.2] group-hover:grayscale-0" alt="Culinary Creation" loading="lazy" sizes="(max-width: 768px) 50vw, 25vw" width="1024" height="1024" />
            </div>
