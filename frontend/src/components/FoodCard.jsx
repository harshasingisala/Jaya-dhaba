...
export default function FoodCard({ item }) {
  ...
  return (
    <div ref={ref} className="glass" onMouseMove={onMove} onMouseLeave={() => ref.current.style.transform = "none"} style={{ padding: 14, transition: "transform .18s ease" }}>
      <ResponsiveImage src={menuImageSrc(item)} alt={item.name} loading="lazy" width="320" height="320" sizes="(max-width: 768px) 100vw, 33vw" style={{ width: "100%", aspectRatio: "1 / 1", borderRadius: 14, objectFit: "cover" }} />
